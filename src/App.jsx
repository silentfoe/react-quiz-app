  ...
  useEffect(() => {
    ...
    fetch(url)
      ...
      .then(data => {
        ...
        setQuizData(quizDataResults.map(obj => {
          return {
            category: atob(obj.category),
            type: atob(obj.type),
            question: atob(obj.question),
            correct_answer: atob(obj.correct_answer),
            incorrect_answers: obj.incorrect_answers.map(answer => atob(answer)),
            id: nanoid()
          }
        }))
      })
...
const questionCard = quizData.map(obj => {
  return <QuestionCard
          ...
          corAns={obj.correct_answer}
          incor={obj.incorrect_answers}
    ...
    <main>
      ...
      {homePage ? // if the homepage state is set to true, then this will show the start quiz button along with the home page
        ...
        <div className='start-page-container'>
          <h1>Quizzical</h1>
          <h3>Select an answer for each question to see if you know your stuff!</h3>
